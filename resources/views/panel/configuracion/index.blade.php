                ...
                <form id="frmEditar" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                            <button type="submit" class="btn btn-success"><i class="fa fa-refresh"></i> Modificar
                            </button>
                            <hr>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group">
                                ...
                                <input type="email" name="correoEditar" id="correoEditar" required class="form-control"
                                       maxlength="100" placeholder="Ejemplo@correo.com" value="{{ $usuario->email }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
                            ...
                            <img style="width: 130px;height: 130px" class="img-thumbnail"
                                 src="{{ $usuario->imagen ? asset('panel/img/usuario/'.$usuario->imagen) :  asset('panel/img/img.webp')  }}"
                                 id="fotoActual">
                        </div>
